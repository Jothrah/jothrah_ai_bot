...
# الإعدادات
# ============================================
TOKEN = "8644966605:AAEFtWopfgoan81cUrhZ1zfFUZfEnAM4d5E"
...
def build_main_buttons(url: str):
    keyboard = [
...
def start(update, context):
    ...
    update.message.reply_text(
        ...
        "✍️ اكتب اسم الآفة أو التصنيف أو المشكلة مثل:\n"
        "مبيدات المن، صراصير، نمل أبيض، الذبابة البيضاء، البياض الدقيقي، مكافحة الفئران والقوارض\n\n"
        "📸 أو أرسل صورة واضحة\n\n"
...
def help_command(update, context):
    update.message.reply_text(
        "🧭 طريقة الاستخدام:\n\n"
        "1) اكتب اسم الآفة أو المرض أو التصنيف.\n"
